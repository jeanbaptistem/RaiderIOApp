package fr.jbme.raiderioapp.model

// Refreshed every 24h
const val BLIZZARD_ACCESS_TOKEN = "US6Uf2B4u0thjzBPMoplsUiEgsV6ZTcTOc"

const val SHARED_PREF_KEY = "fr.jbme.raiderioapp.model.SHARED_PREF_KEY"

const val REALM_NAME_KEY = "fr.jbme.raiderioapp.model.REALM_NAME_KEY"
const val CHARACTER_NAME_KEY = "fr.jbme.raiderioapp.model.CHARACTER_NAME_KEY"
const val REGION_KEY = "fr.jbme.raiderioapp.model.REGION_KEY"

const val RAIDERIO_BASE_URL = "https://raider.io/api/v1/"
const val BLIZZARD_BASE_URL = "https://eu.api.blizzard.com/"
const val BLIZZARD_WEB_BASE_URL = "https://worldofwarcraft.com/en-us/character/"
